...
| fileList | List of files that have been uploaded (controlled). Here is a common issue [#2423](https://github.com/wmstool-design/wmstool-design/issues/2423) when using it | object\[] | - |
