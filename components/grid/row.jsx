...
export default class Row extends React.Component {
    ...
    render() {
        const _a = this.props, { type, justify, align, className, style, children, prefixCls = 'wmstool-row' } = _a, others = __rest(_a, ["type", "justify", "align", "className", "style", "children", "prefixCls"]);
