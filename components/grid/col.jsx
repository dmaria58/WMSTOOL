...
export default class Col extends React.Component {
    render() {
        ...
        const { span, order, offset, push, pull, className, children, prefixCls = 'wmstool-col' } = props, others = __rest(props, ["span", "order", "offset", "push", "pull", "className", "children", "prefixCls"]);
        let sizeClassObj = {};
