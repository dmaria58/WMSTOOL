  ...
  render() {
    ...
    return (
      <div>
        ...
        <Table rowSelection={rowSelection} pagination={{ pageSize: 500 }} onRowClick={this.onRowClick}  scroll={{ x: 1500, y: 300 }} columns={columns} dataSource={data} isMaxData={{id:"testscroll"}}/>
      </div>
    );
  }
}
