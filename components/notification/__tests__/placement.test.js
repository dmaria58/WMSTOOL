...
describe('Notification.placement', () => {
  ...
  it('change notification placement by `open` method', () => {
    ...
    style = getStyle($$('.wmstool-notification-topLeft')[0]);
    ...
    expect($$('.wmstool-notification-topLeft').length).toBe(1);
    ...
    style = getStyle($$('.wmstool-notification-topRight')[0]);
    expect(style.top).toBe(defaultTop);
    ...
    expect($$('.wmstool-notification-topRight').length).toBe(1);
    ...
    style = getStyle($$('.wmstool-notification-bottomRight')[0]);
    ...
    expect($$('.wmstool-notification-bottomRight').length).toBe(1);
    ...
    style = getStyle($$('.wmstool-notification-bottomLeft')[0]);
    expect(style.top).toBe('');
    expect(style.left).toBe('0px');
    expect(style.bottom).toBe(defaultBottom);
    ...
    expect($$('.wmstool-notification-bottomLeft').length).toBe(1);
  });
  ...
  it('change notification mountNode by `config` method', () => {
    ...
    expect($container.querySelector('.wmstool-notification')).not.toBe(null);
    $container.remove();
  });
});
