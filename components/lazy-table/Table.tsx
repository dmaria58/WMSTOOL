...
export default class LazyTable<T> extends React.Component<TableProps<T>, TableState<T>> {
  ...
  createComponents(components: TableComponents = {}, prevComponents?: TableComponents) {
    ...
    if(this.props.lazyLoad){
      this.components = {body: {wrapper: TableWrap.bind(this, this.props.lazyHeight)}};
      return;
    }
  ...
  render() {
    ...
    return (
      <div
        className={classNames(`${prefixCls}-wrapper  wmstool-lazy-table-wrapper`, className)}
        style={style}
      >
        <Spin
          {...loading}
